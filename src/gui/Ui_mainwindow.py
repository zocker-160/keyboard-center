...
"")
        ...
        self.macroKeys.setGeometry(QtCore.QRect(0, 0, 83, 460))
        ...
        self.macroNameEdit = QtWidgets.QLineEdit(self.groupBox_2)
        self.macroNameEdit.setAlignment(QtCore.Qt.AlignCenter)
        self.macroNameEdit.setObjectName("macroNameEdit")
        self.horizontalLayout_8.addWidget(self.macroNameEdit)
        self.horizontalLayout_4.addWidget(self.groupBox_2)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem1)
        self.gameMode = QtWidgets.QGroupBox(self.centralwidget)
        self.gameMode.setCheckable(True)
        self.gameMode.setChecked(False)
        self.gameMode.setObjectName("gameMode")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.gameMode)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.gameModeTime = QtWidgets.QSpinBox(self.gameMode)
        ...
        self.horizontalLayout_9.addWidget(self.gameModeTime)
        self.horizontalLayout_4.addWidget(self.gameMode)
        self.useScripting = QtWidgets.QGroupBox(self.centralwidget)
        self.useScripting.setCheckable(True)
        self.useScripting.setChecked(False)
        self.useScripting.setObjectName("useScripting")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.useScripting)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.editScript = QtWidgets.QPushButton(self.useScripting)
        icon = QtGui.QIcon.fromTheme("document-edit")
        self.editScript.setIcon(icon)
        self.editScript.setObjectName("editScript")
        self.horizontalLayout_10.addWidget(self.editScript)
        self.checkScript = QtWidgets.QPushButton(self.useScripting)
        icon = QtGui.QIcon.fromTheme("dialog-ok")
        self.checkScript.setIcon(icon)
        self.checkScript.setObjectName("checkScript")
        self.horizontalLayout_10.addWidget(self.checkScript)
        self.horizontalLayout_4.addWidget(self.useScripting)
        self.addBox = QtWidgets.QGroupBox(self.centralwidget)
        self.addBox.setObjectName("addBox")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.addBox)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.addKey = QtWidgets.QPushButton(self.addBox)
        icon = QtGui.QIcon.fromTheme("input-keyboard")
        self.addKey.setIcon(icon)
        self.addKey.setObjectName("addKey")
        self.horizontalLayout_5.addWidget(self.addKey)
        self.addDelay = QtWidgets.QPushButton(self.addBox)
        icon = QtGui.QIcon.fromTheme("chronometer")
        self.addDelay.setIcon(icon)
        self.addDelay.setObjectName("addDelay")
        self.horizontalLayout_5.addWidget(self.addDelay)
        self.addCommand = QtWidgets.QPushButton(self.addBox)
        icon = QtGui.QIcon.fromTheme("utilities-terminal")
        self.addCommand.setIcon(icon)
        self.addCommand.setObjectName("addCommand")
        self.horizontalLayout_5.addWidget(self.addCommand)
        self.horizontalLayout_4.addWidget(self.addBox)
        ...
        self.keyListWidgetContents.setGeometry(QtCore.QRect(0, 0, 841, 364))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 950, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.macroNameEdit.setPlaceholderText(_translate("MainWindow", "profile name"))
        self.gameMode.setToolTip(_translate("MainWindow", "<html><head/><body><p>&quot;GameMode&quot; adds a delay between actions.</p><p>Some games struggle to recognize it when execution is too fast.</p></body></html>"))
        self.gameMode.setTitle(_translate("MainWindow", "GameMode"))
        ...
        self.useScripting.setTitle(_translate("MainWindow", "use LUA script"))
        self.editScript.setToolTip(_translate("MainWindow", "edit LUA script"))
        self.checkScript.setToolTip(_translate("MainWindow", "validate LUA script"))
        self.addBox.setTitle(_translate("MainWindow", "Add"))
        self.addKey.setToolTip(_translate("MainWindow", "add key"))
        self.addDelay.setToolTip(_translate("MainWindow", "add delay"))
        self.addCommand.setToolTip(_translate("MainWindow", "add command"))
